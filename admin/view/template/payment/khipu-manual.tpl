      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="khipu_manual_receiverid" value="<?php echo $khipu_manual_receiverid; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="khipu_manual_secret" value="<?php echo $khipu_manual_secret; ?>" />
              <?php if ($error_secret) { ?>
          ...
          <tr>
            ...
            <td><select name="khipu_manual_completed_status_id">
          ...
          <tr>
            ...
            <td><select name="khipu_manual_geo_zone_id">
          ...
          <tr>
            ...
            <td><select name="khipu_manual_status">
          ...
          <tr>
            ...
            <td><input type="text" name="khipu_manual_sort_order" value="<?php echo $khipu_manual_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
